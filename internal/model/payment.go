...
import "github.com/Zhoangp/Payment-Service/pkg/common"
...
type Payment struct {
	...
	RefundStatus   bool            `gorm:"column:refund_status"`
	PaymentCourses []PaymentCourse `gorm:"foreignKey:PaymentId;references:Id"`
}
